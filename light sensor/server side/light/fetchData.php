...
"SELECT DATE_TRUNC('hour', time) AS time, AVG(value) AS value FROM sensors WHERE ( time > NOW()-INTERVAL '1 weeks' AND id = $1) GROUP by DATE_TRUNC('hour',time) ORDER BY time";
